...
Credits.prototype = {
	create: function() {
		...
		var titleText5 = game.add.text(game.world.width/2, (game.world.height/2)+225, "Press [BACKSPACE] to return to main menu", {font: 'Bookman', fontSize: '24px', fill: '#fff'});
