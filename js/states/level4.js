...
Level4.prototype = {
	create: function () {
		...
		//map
		this.map = game.add.tilemap('level4');
		...
		this.door2 = game.add.sprite(352, 1344, 'door');
		this.key3 = game.add.sprite(160, 864, 'key');
		this.fd1 = game.add.sprite(1120, 1344, 'cross');
		game.physics.enable([this.door2, this.key3, this.fd1]);
		this.door2.body.immovable = true;
		this.key3.body.immovable = true;
		this.fd1.body.immovable = true;
		this.door2.body.allowGravity = false;
		this.key3.body.allowGravity = false;
		this.fd1.body.allowGravity = false;
	...
	update: function () {
		...
		game.physics.arcade.overlap(game.player, this.key3, this.keepKey, null, this);
